...
const fuseThemeColor = (color) => ({
    ...
    "primaryColorOpacity-2": common_1.hexToRgba(color, 0.8),
    "primaryColorOpacity-4": common_1.hexToRgba(color, 0.6),
    "primaryColorOpacity-6": common_1.hexToRgba(color, 0.4),
    "primaryColorOpacity-8": common_1.hexToRgba(color, 0.2),
});
