declare const _default: {
    ...
    theme: {
        ...
        backdropBlur: (theme: any) => any;
        backdropBrightness: (theme: any) => any;
        backdropContrast: (theme: any) => any;
        backdropGrayscale: (theme: any) => any;
        backdropHueRotate: (theme: any) => any;
        backdropInvert: (theme: any) => any;
        backdropOpacity: (theme: any) => any;
        backdropSaturate: (theme: any) => any;
        backdropSepia: (theme: any) => any;
        ...
        inset: (theme: any, { negative }: any) => any;
        keyframes: {
            spin: {
                to: {
                    transform: string;
        ...
        margin: (theme: any, { negative }: any) => any;
        maxHeight: (theme: any) => any;
        maxWidth: (theme: any, { breakpoints }: any) => any;
        minHeight: {
            0: string;
            full: string;
            screen: string;
        ...
        space: (theme: any, { negative }: any) => any;
        stroke: {
            current: string;
        };
        strokeWidth: {
        ...
        translate: (theme: any, { negative }: any) => any;
        width: (theme: any) => any;
        zIndex: {
            auto: string;
            0: string;
